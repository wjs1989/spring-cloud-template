			  ...
			  this.$nextTick(() => {
			    ...
			    if (this.form.id) {
			      this.$http({
			        ...
			        if (data && data.code === 0) {
			          this.form.name = data.eduStudent.name
			          this.form.school = data.eduStudent.school
			          this.form.grades = data.eduStudent.grades
			          this.form.parent1 = data.eduStudent.parent1
			          this.form.teleNo1 = data.eduStudent.teleNo1
			          this.form.parent2 = data.eduStudent.parent2
			          this.form.teleNo2 = data.eduStudent.teleNo2
			        }
			      })
			    }
			  })
