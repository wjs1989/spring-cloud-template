package com.elasticsearch.service.reactive;

import com.alibaba.fastjson.JSON;
import com.elasticsearch.core.config.DateFormatter;
import com.elasticsearch.core.config.DefaultDateFormatter;
...
import com.elasticsearch.result.PagerResult;
...
public class ReactiveElasticSearchService implements ElasticSearchService {
    ...
    private Logger log = LoggerFactory.getLogger(ReactiveElasticSearchService.class);
                    ...
                    try {
                        this
                            ...
                            .doOnError((err) -> {
                                ...
                                System.err.println("保存ElasticSearch数据失败:\n" + com.elasticsearch.util.StringUtils.throwable2String(err));
                            })
    ...
    static class Buffer {
        ...
        public static Buffer of(String index, Object payload) {
            ...
            Map<String, Object> data = payload instanceof Map
                ? ((Map) payload) :
                BeanUtils.copyProperties(payload, HashMap::new);
        ...
        public ObjectPool.Handle<Buffer> getHandle() {
            return handle;
        }
    }
    ...
    protected void checkResponse(BulkResponse response) throws Exception {
        if (response.hasFailures()) {
