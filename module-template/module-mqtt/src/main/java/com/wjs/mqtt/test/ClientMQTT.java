...
public class ClientMQTT {
     ...
     */
    public static final String HOST = "tcp://127.0.0.1:1889";
    public static final String TOPIC = "/aaa/1/properties/read";
    private static final String clientid = "1";
    private MqttClient client;
    private MqttConnectOptions options;
    //private String userName = "abc"+"|"+System.currentTimeMillis();
    // private String passWord = stringToMD5(userName +"|"+ "abc");
